...
namespace Gaia
{
    public static class GaiaConstants {
        ...
        public static string GaiaMinorVersion = "0.0";
        ...
        /// </summary>
        public enum ManagerEditorMode {  Standard, Advanced, Utilities }
        ...
        /// </summary>
        public enum ImageFitnessFilterMode { None, ImageGreyScale, ImageRedChannel, ImageGreenChannel, ImageBlueChannel, ImageAlphaChannel, TerrainTexture0, TerrainTexture1, TerrainTexture2, TerrainTexture3 }

        /// <summary>
        /// Classification of feature types - also used to load and save features
        /// </summary>
        public enum FeatureType { Adhoc, Bases, Hills, Islands, Lakes, Mesas, Mountains, Plains, Rocks, Waterfalls, Valleys };
        ...
        /// <summary>
        /// The type of reource that the spawner will use in a spawn rule
        /// </summary>
        public enum SpawnerResourceType { TerrainTexture, TerrainDetail, TerrainTree, GameObject /*, Stamp*/ }

        /// <summary>
        /// Used by system determine what constitutes a valid virgin terrain height check theshold
        /// </summary>
        ...
        /// Storage formats
        /// </summary>
        public enum StorageFormat { PNG, JPG, RAW }
