...
namespace Gaia
{
    ...
    {
        #region Public variables - set these prior to method calls to control the stamper
        ...
        public void AlignToGround()
        {
            ...
            if (t != null)
            {
                terrainHeightOffset = Terrain.activeTerrain.transform.position.y;
            }
        ...
        /// <summary>
        /// Flatten the active terrain - really this should flatten all terrains - who can say what active is
        /// </summary>
        ...
        /// <summary>
        /// Knock ourselves out if we happen to be left on when play is pressed.
        /// </summary>
        void Awake()
        {
            if (Application.isPlaying)
        ...
        void DrawGizmos(bool isSelected)
        {
            ...
            //Water
            if (m_showSeaLevel && m_resources != null)
            {
                Bounds bounds = new Bounds();
                if (TerrainHelper.GetTerrainBounds(transform.position, ref bounds) == true)
                {
        ...
        /// </summary>
        private IEnumerator ApplyStamp()
        {
