...
namespace Gaia
{
    public class ResourceVisualiser : MonoBehaviour {
        ...
        [Tooltip("Visualiser range - controls how fat the visualiser extends.")]
        public float m_range = 200f;

        [Tooltip("Point resolution - smaller numbers mean slower performance."), Range(3f, 50f)]
        ...
        private HeightMap m_resourceFitnessMap;
        //private bool m_needsVisualisationUpdate = false;
        ...
        {
            m_terrainHeightMap = new UnityHeightMap(Terrain.activeTerrain);
            //m_resourceFitnessMap = new HeightMap(m_terrainHeightMap);
