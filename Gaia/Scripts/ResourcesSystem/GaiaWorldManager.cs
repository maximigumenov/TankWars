...
namespace Gaia
{
    ...
    public class GaiaWorldManager
    {
        ...
        /// <summary>
        /// Export the slected splatmap texture as a PNG
        /// </summary>
        ...
        {
            HeightMap hm = new HeightMap(Terrain.activeTerrain.terrainData.GetAlphamaps(0, 0, Terrain.activeTerrain.terrainData.alphamapWidth, Terrain.activeTerrain.terrainData.alphamapHeight), textureIdx );
            hm.Flip();
            Gaia.Utils.CompressToSingleChannelFileImage(hm.Heights(), path, TextureFormat.RGBA32, true, false);
        }
        ...
        public void Test()
        {
            Vector3 position, positionPTI = Vector3.zero;
